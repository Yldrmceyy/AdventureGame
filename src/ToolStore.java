public class ToolStore extends NormalLoc {
    ...
    public void printWeapon() {  //ekrana sılahları bastırmak ıcınn
    ...
    public void buyWeapon() {
        ...
        if (selectWeaponID != 0) {
            Weapon selectedWeapon = Weapon.getWeaponObjByID(selectWeaponID);    //ıd ye göre objeyi getir.
        ...
        if (selectArmorID != 0) {
            ...
            if (selectedArmor != null) {
                if (selectedArmor.getPrice() > this.getPlayer().getMoney()) {
                    System.out.println("Yeterli bakıyenız bulunmamaktadır.");
                } else {
