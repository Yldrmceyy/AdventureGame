...
public abstract class BattleLoc extends Location {
    ...
    public boolean combat(int obsNumber) { //kac tane canavarla savasıcaksam o kadar döngü olusturcam
        ...
        for (int i = 1; i <= obsNumber; i++) {
            ...
            boolean playerFirst = Math.random() > 0.5; // oyuncunun %50 baslama durumu
